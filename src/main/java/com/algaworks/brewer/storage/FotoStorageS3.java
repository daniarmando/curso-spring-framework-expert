...
public class FotoStorageS3 implements FotoStorage {
	...
	private final static Logger logger = LoggerFactory.getLogger(FotoStorageS3.class);
	
	private static final String BUCKET = "aw-daniel-brewer";	
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://aw-daniel-brewer.s3.amazonaws.com/" + foto;
		}
		return null;
	}
